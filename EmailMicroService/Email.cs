...
namespace EmailMicroService
{
    ...
    /// <summary>
    /// A domain name utility
    /// </summary>
    public class DomainNameUtil
    {
        /// <summary>
        /// Searches for the first DNS 
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Gets IP host entry for mail exchange
        /// </summary>
        ...
        /// <summary>
        /// Gets authority servers
        /// </summary>
        /// <param name="answer">The</param>
        /// <returns></returns>
