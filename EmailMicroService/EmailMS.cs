...
namespace EmailMicroService
{
    public class EmailMS : BaseMicroService<EmailMS, DeploymentStopMessage>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the EmailMicroService.EmailMS class
        /// </summary>
        public EmailMS()
        {
        ...
        /// <summary>
        /// Process the email send request message descrbited by msg.
        /// </summary>
        ...
        {
            Console.WriteLine(EmailSender.Send(msg.From, msg.To, msg.Subject, msg.Body) ? "Email sent" : "Email not sent");
        }
    }
}
