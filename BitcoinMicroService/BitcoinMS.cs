...
namespace BitcoinMicroService
{
    public class BitcoinMS : BaseMicroService<BitcoinMS, HealthStatusMessage>, ILeaseManager
    {
        ...
        /// <summary>
        /// Initializes a new instance of the BitcoinMicroService.BitcoinMS class
        /// </summary>
        public BitcoinMS()
        {
        ...
        /// Acquire the lease
        /// </summary>
        /// <param name="options">Optins for controlling the operation</param>
        ...
        /// renew lease
        /// </summary>
        /// <param name="options">optins for controlling the operations</param>
        /// <param name="token">The token</param>
        /// <returns>The asynchronous result that yields true if it succeeds, false if it fails</returns>
        ...
        /// <summary>
        /// Process the bitcoin spend message described by msg.
        /// </summary>
